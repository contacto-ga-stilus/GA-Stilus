...
// firebase removed; using hardcoded demo categories
...
export default function CatalogoDama() {
  ...
  useEffect(() => {
    ...
    setCategories([
      { id: 'accesorio', nombre: 'Accesorios', imageName: 'accesorioDama' },
      { id: 'playera', nombre: 'Playeras', imageName: 'playeraDama' },
      { id: 'vestido', nombre: 'Vestidos', imageName: 'vestidoDama' },
    ]);
  }, []);
  ...
  return (
    <section id="dama" className="catalog-section">
      <div className="catalog-content">
        <h2 className="catalog-title">Catálogo de Dama</h2>
